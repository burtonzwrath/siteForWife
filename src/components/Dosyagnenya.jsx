...
function Dosyagnenya(props) {
  return (
    <div className="flex h-screen  justify-center items-center  ">
      ...
      <div className=" h-3/4 w-3/4  sm:w-1/2 rounded-xl z-10 bg-green-50   flex justify-center items-center shadow-[0_0_20px_10px_rgba(0,0,0,0.6) shadow-[inset_0_0_30px_rgba(84,205,213,0.7),0_0_20px_10px_rgba(0,0,0,0.6)]">
        <div className="h-80 ">
          <div className="">
