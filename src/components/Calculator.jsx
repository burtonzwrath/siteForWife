  ...
  return (
    <div>
      ...
      <div id="calc" className=" relative w-3/12 mx-auto mt-20 mb-20 ">
        <div
          id="calcContainer"
          className=" p-4 flex flex-col gap-2 items-center bg-white rounded-tl-3xl  rounded-br-3xl  shadow-[inset_0_0_60px_rgba(84,205,213,0.7),0_0_20px_10px_rgba(0,0,0,0.6)]"
        >
          ...
          <div className="flex flex-col gap-2 items-center m-4">
            <label
              className="italic text-lg text-sky-700 font-semibold"
              htmlFor="height"
            >
              Рост
            </label>
            ...
            <div className="flex">
              <h2 className=" text-xl  italic text-sky-700 font-semibold ">
                Ваш индекс массы:
              </h2>{" "}
              {h3}
            </div>
