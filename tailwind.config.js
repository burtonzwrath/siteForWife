  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        move: "x 4s 4s linear infinite",
        moveSec: "x s  linear infinite ",
        cogAnimation: "cog 6s linear infinite",
        cogAnimationReverse: "cog 6s linear infinite reverse",
        sun1: "sun1 2s 2s linear forwards ",
        sun2lg: "sun2lg 2s  linear forwards ",
        sun2: "sun2 2s 2.6s linear forwards",
        sun3: "sun3 2s 3.2s  linear forwards",
        sun4: "sun4 2s 3.8s  linear forwards",
        sun5: "sun5 2s 4.4s  linear forwards",
        sun6: "sun6 2s 5s   linear forwards",
        ...
        nameShow:"nameShow 2s 7s linear forwards"
      },
    },
  },
  plugins: [],
